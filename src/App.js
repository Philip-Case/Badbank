  ...
  return (
    ...
    <div className="App">
      ...
      <footer className="text-center text-md-right">
        <List type="inline">
          <ListInlineItem>
            <a href="https://github.com/Philip-Case" target="_blank">
              <img src={ githubicon }/>
            </a>
          </ListInlineItem>
          <ListInlineItem>
            <a href="https://www.linkedin.com/in/philipcase/" target="_blank">
              <img src={ linkedinicon }/>
            </a>
          </ListInlineItem>
          <ListInlineItem>
            <a href="mailto:philipbcase@gmail.com" target="_blank">
              <img src={ emailicon }/>
            </a>
          </ListInlineItem>
        </List>
